...
import 'browser/TLPCToken.sol';
import 'browser/Pausable.sol';

contract TLPCTokenOffering is Pausable {
    ...
    function updateRate(uint256 TLPCToEtherRate) public onlyOwner atStage(Stages.Setup) {
        rate = TLPCToEtherRate;
    }
